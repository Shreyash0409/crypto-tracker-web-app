  ...
  return (
    <div className={classes.maindiv}>
      ...
      <div className={classes.content}>
        ...
        >{`₹${current_price.toLocaleString()}`}</span>
      </div>
      <div className={classes.secondContent}>
        ...
        <div>
          ...
          <p className={classes.para}>
            ...
            <span className={classes.percentage}>{`${price_change_percentage_24h
              .toFixed(2)
              .toLocaleString()}%`}</span>
          </p>
        </div>
      ...
      <div className={classes.secondContent}>
        ...
        <div>
          <span
            className={classes.span}
          >{`₹${high_24h.toLocaleString()}/`}</span>
          <p className={classes.span}>{`₹${low_24h.toLocaleString()}`}</p>
        </div>
      </div>
      <div className={classes.secondContent}>
        <span>
        ...
        <div>
          <span
            className={classes.span}
          >{`₹${total_volume.toLocaleString()}`}</span>
        </div>
      </div>
      <div className={classes.secondContent}>
      ...
      <div className={classes.secondContent}>
        ...
        <div>
          <span
            className={classes.span}
          >{`₹${market_cap.toLocaleString()}`}</span>
        </div>
      </div>
      <div className={classes.secondContent}>
        <span>
        ...
        <div>
          <span
            className={classes.span}
          >{`₹${market_cap_change_24h.toLocaleString()}`}</span>
          <p className={classes.para}>
            <i className={`fas fa-angle-up ${classes.percentage}`}></i>
            <span
      ...
      <div className={classes.secondContent}>
        ...
        <div>
          <span className={classes.span}>{`₹${ath.toLocaleString()}`}</span>
          <p className={classes.para}>
      ...
      <div className={classes.secondContent}>
        ...
        <div>
          <span className={classes.span}>{`₹${atl.toLocaleString()}`}</span>
          <p className={classes.para}>
            <i className={`fas fa-angle-down ${classes.percentage}`}></i>
            <span
              className={classes.percentage}
      ...
      <div className={classes.secondContent}>
        ...
        <div>
          <span
            className={classes.span}
          >{`${circulating_supply.toLocaleString()} ${symbol.toUpperCase()}`}</span>
        </div>
      </div>
      <div className={classes.secondContent}>
        ...
        <div>
          <span className={classes.span}>
            {total_supply !== null
              ? `${total_supply.toLocaleString()} ${symbol.toUpperCase()}`
              : `--`}
          </span>
        </div>
      </div>
      <div className={classes.secondContent}>
        ...
        <div>
          <span className={classes.span}>
            {max_supply !== null
              ? `${max_supply.toLocaleString()} ${symbol.toUpperCase()}`
              : `--`}
          </span>
        </div>
      </div>
